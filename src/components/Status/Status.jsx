    ...
    return (
        <div className="max-w-[1160px] mx-auto w-11/12">
            ...
            <div className="flex justify-between items-end gap-5 ">
                <div className="bg-white h-[300px] p-5 rounded-3xl border-2 shadow-xl w-full transition-transform transform hover:scale-110">
                ...
                <div className=" h-[200px] bg-[#FFFFF5] p-5 rounded-3xl border-2 shadow-xl w-full transition-transform transform hover:scale-110">
                    <h1 className="text-4xl font-bold">500+</h1>
                    <p>Board-certified doctors</p>
                    <img className='ml-[50%]' src={certificate} alt="" />
                </div>
                <div className="bg-white h-[160px] p-5 rounded-3xl border-2 shadow-xl w-full transition-transform transform hover:scale-110">
